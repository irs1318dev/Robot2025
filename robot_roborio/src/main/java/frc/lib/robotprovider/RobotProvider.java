...
public class RobotProvider implements IRobotProvider
{
    ...
    {
        return SparkMaxWrapper.create(deviceId, motorType);
    }

    @Override
    public ISparkFlex getSparkFlex(int deviceId, SparkMotorType motorType)
    {
        return SparkFlexWrapper.create(deviceId, motorType);
    }
    ...
    public IPowerDistribution getPowerDistribution()
    {
        ...
        if (this.powerDistribution == null)
        {
            this.powerDistribution = new PowerDistributionWrapper();
        }
    ...
    public IPowerDistribution getPowerDistribution(int module, PowerDistributionModuleType moduleType)
    {
        ...
        if (this.powerDistribution == null)
        {
            this.powerDistribution = new PowerDistributionWrapper(module, moduleType);
        }
    ...
    public INetworkTableProvider getNetworkTableProvider()
    {
        ...
        {
            return AKNetworkTableProvider.Instance;
        }
        else
        {
    ...
    {
        return PathPlannerWrapper.Instance;
    }
