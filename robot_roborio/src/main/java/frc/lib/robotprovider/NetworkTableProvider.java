...
public class NetworkTableProvider extends NetworkTableProviderBase
{
    public static final NetworkTableProvider Instance = new NetworkTableProvider();

    private NetworkTableProvider()
    {
    }
