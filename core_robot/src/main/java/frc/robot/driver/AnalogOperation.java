...
public enum AnalogOperation implements IOperation
{
    ...
    // Coral EndEffector operations:
    CoralWristPowerA,
    CoralWristPowerB,
    CoralWristAdjustAngleRight,
    CoralWristAdjustAngleLeft,
    CoralWristDesiredAngle,

    // Algae EndEffector operations:
    AlgaeWristPower,
    AlgaeWristAngleAdjustment,
    AlgaeWristDesiredAngle,

    // Elevator Operations:
    ElevatorPower,
    ElevatorPositionAdjustment,
    ElevatorDesiredPosition,

    // Climber Operations:
    ClimberElbowPower,
    ClimberElbowAngleAdjustment,
    ClimberElbowDesiredAngle,
}
