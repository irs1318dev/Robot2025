...
public class FollowPathTask extends ControlTaskBase
{
    ...
    /**
     * Initializes a new FollowPathTask
     * @param alliance the alliance to follow the path for
     * @param pathName the path to follow
     * @param type describing how to follow the path
     */
    public FollowPathTask(Alliance alliance, String pathName, Type type)
    {
        this(pathName + alliance.toString(), type);
    }
    ...
    public void begin()
    {
        ...
        if (this.trajectory == null)
        {
            ...
            System.out.println(String.format("No such path %s", this.pathName));
            this.startTime = 0.0;
        ...
        System.out.println(String.format("starting path %s, dur %f, end pos: %f", this.pathName, this.trajectoryDuration, this.trajectory.get(this.trajectoryDuration).xPosition));
    ...
    {
        return !this.shouldCancel && this.timer.get() > this.startTime + this.trajectoryDuration;
    }
}
