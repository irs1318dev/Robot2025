...
public class PowerManager implements IMechanism
{
    ...
    public PowerManager(IDriver driver, ITimer timer, LoggingManager logger, IRobotProvider provider)
    {
        ...
        this.currentAverageCalculator = new FloatingAverageCalculator(timer, TuningConstants.POWER_OVERCURRENT_TRACKING_MIN_VALUE, TuningConstants.POWER_OVERCURRENT_TRACKING_MAX_VALUE, TuningConstants.POWER_OVERCURRENT_TRACKING_DURATION, TuningConstants.POWER_OVERCURRENT_SAMPLES_PER_SECOND);
